package com.example.tutorial_05_form_validation.models
...
class FormData(
    ...
    fun validateStudentId(): ValidationResult {  //validateStudentId() function returns a ValidationResult object
